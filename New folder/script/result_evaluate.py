...
def imbalance_data_plot():
    ...
    for group_name in group_object.groups:
        ...
        sns.lineplot(data=group_df,x="pos",y="label1_percentage",color="blue").axhline(0.6,)
        sns.lineplot(data=group_df, x="pos", y="label0_percentage", color="blue").axhline(0.4,)
        # plt.savefig("../result/log_spline_predict_result_lstm_DH_LA_and_Height/chr{}.png".format(group_name),dpi=800)
        sns.scatterplot(data=group_df,x="pos",y="accuracy",hue="mark")
